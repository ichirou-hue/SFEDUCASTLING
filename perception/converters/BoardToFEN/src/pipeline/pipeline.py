...
from perception.converters.BoardToFEN.src.fen_converter.fen_converter import (
    convert_pieces_to_fen,
)
from perception.converters.BoardToFEN.src.input_utils.image_capture import ImageCapture
